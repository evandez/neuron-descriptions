...
GDRIVE_IDS = {
    zoo.KEYS.ALEXNET: '1BmgExiP10P5j0irBiCf2TVwFpNnXTVOv',
    zoo.KEYS.DENSENET121: '1yeKuiREpdl9ltyVQEcfzgAcjkfK9Punj',
    zoo.KEYS.DENSENET201: '1s3lGJ8Lq67LVgpa9nArUnt-Augfnd7mP',
    zoo.KEYS.MOBILENET_V2: '1DJIgaQVsRroY1TInBzqenXwXTQR6X4hk',
    zoo.KEYS.RESNET18: '1woDKMm90armYrOZ9lfXTg-MWhWNA0eDD',
    zoo.KEYS.RESNET34: '10Kqkr3ULhzV_llN6lgBfZ4TOd6uz-iDW',
    zoo.KEYS.RESNET50: '1dmT7HVyTp8OwFEbgIDN6P5RNuvsLpWEC',
    zoo.KEYS.RESNET101: '1tnG1gKRL2VrXMS_zD09KERFt9nbzuXq_',
    zoo.KEYS.RESNET152: '1LxrgwDKijRqBAxy9odPqKRELASBLFBOa',
    zoo.KEYS.SHUFFLENET_V2_X1_0: '1ifWeFumTS9Kjbvq0hm1hpVrJaYgJFg5Y',
    zoo.KEYS.SQUEEZENET1_0: '15Ro0jRzpk9-5q_U-rKZlMpe4jHLg_jXi',
    zoo.KEYS.VGG11: '1AhzaMsxTpM08Q22sp94aF2U-Xerd4uE5',
    zoo.KEYS.VGG13: '1fyNnwpath6_BcfgtqaZ1DRnyZr4QhKFe',
    zoo.KEYS.VGG16: '18hyyLVplUZUi2u1_Y-MYsJ5JL3aG7n3H',
    zoo.KEYS.VGG19: '1FhvooAy-ahtX_vyoxwlmOi8VJlj7JE-j',
}
...
for name, file in downloaded_files.items():
    ...
    model_file = models_dir / f'{name}-{zoo.KEYS.IMAGENET_BLURRED}.pth'
