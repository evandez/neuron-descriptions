...
def training_loader(z_generator, batch_size, loader_size=10000, **kwargs):
    '''
    Returns an infinite generator that runs through randomized z
    batches, forever.
    '''
    g_epoch = 1
    loader_args = dict(shuffle=False,
...
def testing_loader(z_generator, batch_size, test_size=1000, **kwargs):
    '''
